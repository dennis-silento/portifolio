  ...
  return (
    ...
    >
      <div className="flex justify-center items-center text-center">
        <Title title="What clients says " des="Testimonials" />
      </div>
            ...
            <div className="w-full h-[500px] flex justify-between">
              <div className="w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold">Denno Silento</h3>
                  <p className="text-base tracking-wide to-gray-500">
                    Operational manager
                  </p>
                </div>
              </div>
              <div className="w-[60%] h-full flex flex-col justify-between">
                <img className="w-[20%]" src={quote} />
                <div className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] rounded-lg shadow-shadowOne p-8 flex flex-col gap-8">
